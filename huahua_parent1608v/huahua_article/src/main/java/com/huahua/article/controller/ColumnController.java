...
public class ColumnController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/column/{columnId}/{page}/{size}")
	public Result findArticleListByColumnId(@PathVariable String columnId,
											@PathVariable Integer page,
											@PathVariable Integer size){
		Page<Column> columnPage = columnService.findArticleListByColumnId(columnId, page, size);
