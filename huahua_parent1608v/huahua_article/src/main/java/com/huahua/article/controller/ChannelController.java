...
public class ChannelController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/channel/{channelId}/{page}/{size}")
	public Result findArticleListByChannelId(@PathVariable String channelId,
						   @PathVariable Integer page,
						   @PathVariable Integer size){
		Page<Channel> channelPage = channelService.findArticleListByChannelId(channelId, page, size);
